    ...
    return (
        <>
            <div>
                ...
                <div class="offcanvas offcanvas-start side" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                        ...
                        <div className='mx-3 mt-4'>
                            <div className='text-dark'>
                               <Link to="/home" className='nav-link'>
                                ...
                                <div className='mt-3'>
                                    <Link to="/buydata" className='nav-link'>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <span className='mx-2 list'>Recharge DsTv</span>
                                </div>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <span className='mx-2 list'>Recharge StarTime</span>
                                </div>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <span className='mx-2 list'>Airtime to cash</span>
                                </div>
                                ...
                                <div className='mt-3'>
                                    ...
                                    <span className='mx-2 list'>Check Result</span>
                                </div>

                                <div className='mt-3'>
                                    <button className='btn text-light balD'>

                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-door-open" viewBox="0 0 16 16">
                                            <path d="M8.5 10c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z" />
                                            <path d="M10.828.122A.5.5 0 0 1 11 .5V1h.5A1.5 1.5 0 0 1 13 2.5V15h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V1.5a.5.5 0 0 1 .43-.495l7-1a.5.5 0 0 1 .398.117zM11.5 2H11v13h1V2.5a.5.5 0 0 0-.5-.5zM4 1.934V15h6V1.077l-6 .857z" />
                                        </svg>
                                        <span className='mx-2 list'>LOGOUT</span>
                                    </button>
                                </div>
                            </div>
                        </div>
