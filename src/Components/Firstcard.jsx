      ...
      <div className='container-fluid mt-5 pt-2 ps-5 pe-5'>
          <div className='row'>
              ...
              <div className='col-sm-12 col-md-6 col-lg-3 mt-3 mx-auto cardbg rounded text-center p-3'>
                  ...
                  <p>Pay for your Tv/Cable (Dstv, Gotv, etc.), Internet, Electricity & other merchants using the Aimtoget app.</p>
              </div>
              ...
              <div className='col-sm-12 col-md-6 col-lg-3 mt-3 mx-auto cardbg rounded text-center p-3'>
                  ...
                  <p>Send and receive payments, pay bills & Receive & send cash using Aimtoget.</p>
              </div>
              ...
              <div className='col-sm-12 col-md-6 col-lg-3 mt-3 mx-auto cardbg rounded text-center p-3'>
                  ...
                  <p>With Aimtoget, you can send & receive money with ease. Send money to bank, merchants & other users instantly.</p>
              </div>
